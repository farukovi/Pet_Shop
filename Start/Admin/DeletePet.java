...
public class DeletePet extends JFrame implements ActionListener
{
	...
	{
		boolean inter = true;
		if(namefiled.getText().equals("") || mailfield.getText().equals("") || cellfield.getText().equals("") || addField.getText().equals("") || petField.getText().equals("") || ageField.getText().equals(""))
		{
		...
		{	if(inter == true)
			{	
				String query = "DELETE FROM pets_info WHERE Id="+x;
				Connection con = null;
				Statement st = null;
				System.out.println(query);
